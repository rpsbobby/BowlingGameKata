...
inline std::vector<Frame> make_strike() { return std::vector<Frame>(10, Frame{10, 0}); }

inline std::vector<Frame> make_complete() { return std::vector<Frame>(10, Frame{5, 4}); }

inline std::vector<Frame> make_incomplete() { return std::vector<Frame>(9, Frame{5, 4}); }

inline std::vector<Frame> make_spare() { return std::vector<Frame>(10, Frame{5, 5}); }

inline std::vector<Frame> make_gutter() { return std::vector<Frame>(10, Frame{0, 0}); }

inline std::vector<Frame> make_ones() { return std::vector<Frame>(10, Frame{1, 1}); }
...
inline Bonus make_bonus_strike_5() { return {BonusType::Strike, 5, 5}; }

inline Bonus make_bonus_spare_0() { return {BonusType::Spare, 0}; }

inline Bonus make_bonus_spare_5() { return {BonusType::Spare, 5}; }

inline Bonus make_bonus_strike_10() { return {BonusType::Strike, 10, 10}; }

inline Bonus make_bonus_spare_10() { return {BonusType::Spare, 10}; }

inline Bonus make_bonus_none() { return {BonusType::None, -1, -1}; }
